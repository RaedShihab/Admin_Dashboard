...
class Delete extends React.Component {
  ...
  deleteUser = ()=> {
    ...
    axios.delete('https://jsonplaceholder.typicode.com/users/'+this.cityId , { id: this.cityId })
      .then(res => {
        console.log(res)
        this.setState({
          showLoading: false,
    ...
    return (
      <div>
        ...
        >
          ...
          >
                       {t("the_city_has_deleted_successfuly")}
          </Alert>
        </Snackbar>
        ...
        >
          <DialogTitle>{t("are_you_sure_delete_city")}</DialogTitle>
          <Button
